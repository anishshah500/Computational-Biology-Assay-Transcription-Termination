...
inp = open('/net/nevermind/data/nm/anishns/nascentdata/thousand_nucleotides_surrounding.bed','r').readlines()
length = len(inp)
out = open('/net/nevermind/data/nm/anishns/nascentdata/consider_positions_for_sequence_search_gtf.bed','w')
